...
titles = ['Vectorized Implementation', 'Parallelized Implementation', 'Parallelized Implementation without Loops']
...
os.makedirs('plot_all', exist_ok=True)	# create directory if not exists
dir_name = 'plot_all/'
